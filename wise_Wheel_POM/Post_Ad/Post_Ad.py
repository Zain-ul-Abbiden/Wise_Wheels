...
driver.find_element(By.XPATH,"//nav[@role='navigation']//a[@class='btn btn-block btn-border btn-listing'][normalize-space()='Post Your Ad']").click()
time.sleep(5)

# actions = ActionChains(driver)
# actions.send_keys(Keys.ESCAPE).perform()
#
# driver.find_element(By.XPATH, "//a[normalize-space()='Select a category']").click()
# time.sleep(2)
# driver.find_element(By.XPATH, "//h6[normalize-space()='Sedan']").click()
# time.sleep(2)
# driver.find_element(By.XPATH, "//h6[normalize-space()='Cars']").click()
# time.sleep(2)
# driver.find_element(By.CSS_SELECTOR, "body > div:nth-child(25) > div:nth-child(9) > div:nth-child(1) > div:nth-child(1) > div:nth-child(2) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > form:nth-child(1) > fieldset:nth-child(3) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(2) > div:nth-child(2) > div:nth-child(1) > input:nth-child(1)").send_keys("ABCDEFGHIKL")
# time.sleep(2)
#
# iframe = driver.find_element(By.XPATH, "//iframe[@id='description_ifr']")
# driver.switch_to.frame(iframe)
# print("Switch Iframe")
# # Step 4: Find the text box and write text
# textbox = driver.find_element(By.XPATH, "//*[@id='tinymce']")
# textbox.clear()
# textbox.send_keys("XYZZZZZZZZZZZZZZZZZZZZZZ")
# time.sleep(2)
# driver.switch_to.default_content()

driver.find_element(By.XPATH, "//button[normalize-space()='2024']").click()
time.sleep(5)
driver.find_element(By.XPATH, "//button[normalize-space()='Toyota']").click()
time.sleep(5)
driver.find_element(By.XPATH, "//button[normalize-space()='Yaris Sedan']").click()
time.sleep(5)
driver.find_element(By.XPATH, "//button[normalize-space()='ATIV X CVT 1.5 Beige Interior']").click()
time.sleep(5)
driver.find_element(By.XPATH, "//button[@class='btn btn-success btn-lg d-block mx-auto']").click()
print("Test Pass 4")
time.sleep(2)
#=========================================================
...
first_option = wait.until(EC.element_to_be_clickable((By.ID, "cf.6.309")))
first_option.click()
print("Click ABS")
...
try:
	element.click()
	print("Submit button clicked successfully / Post Ad Successfully")
