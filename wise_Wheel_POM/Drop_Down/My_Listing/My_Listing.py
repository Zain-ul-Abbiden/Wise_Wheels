...
dropdown = Select(dropdown_element)
dropdown.select_by_visible_text("Individuals")
print("SELLER TYPE ")
time.sleep(3)

dropdown_element = driver.find_element(By.ID, "cf.1")
dropdown = Select(dropdown_element)
dropdown.select_by_visible_text("Dodge")
print("MAKE *")
time.sleep(3)

driver.find_element(By.ID, "cf.2").clear()
driver.find_element(By.ID, "cf.2").send_keys("Best Three")
print("Model")
time.sleep(5)

driver.find_element(By.ID, "cf.3").clear()
driver.find_element(By.ID, "cf.3").send_keys("1990")
print("Year")
time.sleep(5)
#===============================Feature=================================

driver.find_element(By.NAME, "cf[6][311]").click()
time.sleep(2)

driver.find_element(By.NAME, "cf[6][353]").click()
time.sleep(2)

driver.find_element(By.NAME, "cf[6][338]").click()
time.sleep(2)

driver.find_element(By.NAME, "cf[6][306]").click()
time.sleep(2)
# =====================================Price=========================================================
